...
namespace ZeroGUI
{
	namespace Colors
	{
		...
		flinearcolor Window_Background = { 0.10f, 0.10f, 0.10f, 1.0f };
		flinearcolor Window_Header = { 0.769f, 0.059f, 0.902f, 1.0f };

		flinearcolor Button_Idle = { 0.769f, 0.059f, 0.902f, 1.0f };
		flinearcolor Button_Hovered = { 0.769f, 0.059f, 0.902f, 1.0f };
		flinearcolor Button_Active = { 0.7f, 0.05f, 0.9f, 1.0f };

		flinearcolor Checkbox_Idle = { 0.15f, 0.15f, 0.15f, 1.0f };
		flinearcolor Checkbox_Hovered = { 0.15f, 0.15f, 0.15f, 1.0f };
		flinearcolor Checkbox_Enabled = { 0.769f, 0.059f, 0.902f, 1.0f };
		...
		flinearcolor Slider_Button = { 0.769f, 0.059f, 0.902f, 1.0f };
	...
	void Text(const char* text, bool center = false, bool outline = false)
	{
		...
		if (center)
			...
			TextLeft(text, textPos, flinearcolor{ 1.0f, 1.0f, 1.0f, 1.0f }, outline); // peson replace the "e" with "a" and "y" made this
